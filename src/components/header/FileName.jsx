...
const FileName = () => {
  const { selectedNote, getNote, updateName } = useNotes();
  ...
  return (
    <div className="flex items-center gap-4 mr-auto">
        ...
        <div>
            ...
            <input className="bg-transparent text-grey-100" value={note.name} onChange={(e) => updateName(selectedNote, e.target.value )}/>
        </div>
    </div>
  )
}
